...
def generate_sample_alerts(num_alerts=50):
    ...
    sample_ips = [
        "192.168.1.100",
        "10.0.0.15",
        "172.16.0.20",  # Internal IPs
        "185.220.101.42",
        "94.102.49.190",
        "198.98.51.189",  # Suspicious IPs
        "8.8.8.8",
        "1.1.1.1",
        "208.67.222.222",  # Legitimate external
        "45.33.32.156",
        "167.172.203.244",
        "104.248.169.218",  # Mixed
    ]
    ...
    for alert in alerts:
        ...
        normalized_alert = {
            ...
            "destination_ip": alert.get(
                "destination_ip", alert.get("dst_ip", "0.0.0.0")
            ),
            ...
            "destination_port": int(
                alert.get("destination_port", alert.get("dst_port", 0))
            ),
            "protocol": alert.get("protocol", "TCP"),
            "bytes_transferred": int(
                alert.get("bytes_transferred", alert.get("bytes", 0))
            ),
